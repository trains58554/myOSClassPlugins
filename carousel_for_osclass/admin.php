...
<form action="<?php osc_admin_base_url(true); ?>" method="post">
    ...
    <div>
    <fieldset>
        <h2><?php _e('Carousel for Osclass Preferences', 'carousel'); ?></h2> 
        ...
        <select name="picOnly" id="picOnly">
        	<option <?php if($picOnly ==0){echo 'selected="selected"';}?> value='0'><?php _e('No', 'carousel'); ?></option>
        	<option <?php if($picOnly ==1){echo 'selected="selected"';}?> value='1'><?php _e('Yes', 'carousel'); ?></option>
        </select>
        <?php if( osc_price_enabled_at_items() ) { ?>
        <br />
        <label for="priceEnab" style="font-weight: bold;"><?php _e('Enable Price','carousel'); ?></label>:<br />
        <select name="priceEnab" id="priceEnab">
        	<option <?php if($priceEnab ==0){echo 'selected="selected"';}?> value='0'><?php _e('No', 'carousel'); ?></option>
        	<option <?php if($priceEnab ==1){echo 'selected="selected"';}?> value='1'><?php _e('Yes', 'carousel'); ?></option>
        </select>
        <?php } ?>
        <br />
        <label for="arrows" style="font-weight: bold;"><?php _e('Enable Arrows','carousel'); ?></label>:<br />
        <select name="arrows" id="arrows">
        	<option <?php if($arrows ==0){echo 'selected="selected"';}?> value='0'><?php _e('No', 'carousel'); ?></option>
        	<option <?php if($arrows ==1){echo 'selected="selected"';}?> value='1'><?php _e('Yes', 'carousel'); ?></option>
        </select>
        <br />
        <br />
