                    ...
                    <div class="navigation">
                        ...
                        <div class="box location">
                            ...
                            <?php while( osc_has_list_countries() ) { ?>
                                <li><a href="<?php echo osc_search_url(array('sCountry' => osc_field(osc_list_country(), 'country_name', ''))) ; ?>"><?php echo osc_field(osc_list_country(), 'country_name', '') ; ?></a> <em>(<?php echo osc_country_items() ; ?>)</em></li>
                            <?php } ?>
                            </ul>
                        </div>
                        <?php } ?>
                        <?php // uncomment the section below if you want the facebook social plugin ?>
                    	<!--<div class="box location">
