                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="datatables_list">
	                                       ...
	                                       if($userOffer['user_id'] !=''){
                                        	...
                                        	?>
                                        		...
                                        		<td><?php echo $user['s_name']; ?> <a title="<?php echo __('Send Email to ','offer_button') . $user['s_email']; ?>" href="mailto:<?php echo $user['s_email'] . '?subject=' . $itemTitle; ?>"><?php echo $user['s_email']; ?></a><div><?php if(($userOffer['offer_status'] == 2) || ($userOffer['offer_status'] == 3)){?><a href="<?php echo osc_base_url(true).'?page=custom&file=offerButton/offer_edit.php&offer-action=accept&offer-id='.$userOffer['id'] .'&user-id=' . $userOffer['user_id'] . '&item-id=' . $userOffer['item_id'] . '&b_email=' . $userOffer['b_email'] . '&b_name=' . $userOffer['b_name']; ?>" onclick="<?php if(($userOffer['user_locked'] == 1) || ($offer_accept == 1)){ echo 'return false'; } ?>"><?php }?><?php _e('Accept', 'offer_button'); ?><?php if(($userOffer['offer_status'] == 2) || ($userOffer['offer_status'] == 3)){?></a><?php }?> | <?php if(($userOffer['offer_status'] == 1) || ($userOffer['offer_status'] == 3)){?><a href="<?php echo osc_base_url(true).'?page=custom&file=offerButton/offer_edit.php&offer-action=pending&offer-id='.$userOffer['id'] .'&user-id=' . $userOffer['user_id'] . '&item-id=' . $userOffer['item_id'] . '&b_email=' . $userOffer['b_email'] . '&b_name=' . $userOffer['b_name']; ?>" onclick="<?php if($userOffer['user_locked'] == 1){ echo 'return false'; } ?>"><?php }?><?php _e('Pending', 'offer_button'); ?><?php if(($userOffer['offer_status'] == 1) || ($userOffer['offer_status'] == 3)){?></a><?php }?> | <?php if(($userOffer['offer_status'] == 1) || ($userOffer['offer_status'] == 2)){?><a href="<?php echo osc_base_url(true).'?page=custom&file=offerButton/offer_edit.php&offer-action=declined&offer-id='.$userOffer['id'] .'&user-id=' . $userOffer['user_id'] . '&item-id=' . $userOffer['item_id'] . '&b_email=' . $userOffer['b_email'] . '&b_name=' . $userOffer['b_name']; ?>" onclick="<?php if($userOffer['user_locked'] == 1){ echo 'return false'; } ?>"><?php }?><?php _e('Decline', 'offer_button'); ?><?php if(($userOffer['offer_status'] == 1) || ($userOffer['offer_status'] == 2)){?></a><?php }?> <?php if(osc_offerButton_email() ==1){ ?><a title="<?php echo __('Send Email to ','offer_button') . $user['s_email']; ?>" href="mailto:<?php echo $user['s_email'] . '?subject=' . osc_item_title(); ?>"><img src="<?php echo osc_base_url() . 'oc-content/plugins/offerButton/images/email_compose.png'; ?>"  width="25px" height="25px" alt="<?php _e('send email','offer_button'); ?>" /></a><?php } ?> <?php if(osc_offerButton_locking() == 1 ){ ?><a class="<?php if($userOffer['user_locked'] == 1){ echo 'gray';} ?>" title="<?php echo __('Lock User','offer_button'); ?>" href="<?php echo osc_base_url(true) . '?page=custom&file=offerButton/offer_edit.php&offer-action=reasonLock&offer-id='.$userOffer['id'] .'&user-id=' . $userOffer['user_id'] . '&item-id=' . $userOffer['item_id'] . '&n-user=' . $userName; ?>"><img src="<?php echo osc_base_url() . 'oc-content/plugins/offerButton/images/Lock.png'; ?>"  width="25px" height="25px" alt="<?php _e('Lock User','offer_button'); ?>" /></a><a class="<?php if($userOffer['user_locked'] == 0){ echo 'gray';} ?>" title="<?php echo __('Unlock User','offer_button'); ?>" href="<?php echo osc_base_url(true) . '?page=custom&file=offerButton/offer_edit.php&offer-action=unlock&offer-id='.$userOffer['id'] .'&user-id=' . $userOffer['user_id'] . '&item-id=' . $userOffer['item_id'] . '&n-user=' . $userName; ?>"><img src="<?php echo osc_base_url() . 'oc-content/plugins/offerButton/images/Lock-Open.png'; ?>"  width="25px" height="25px" alt="<?php _e('Unlock User','offer_button'); ?>" /></a><?php } ?></td>
                                        		<td><?php if($offer['offer_type'] == 1) { echo sprintf(__('$%.2f','offer_button'), $userOffer['offer_value']);}else if($offer['offer_type'] == 2){_e('Trade','offer_button');}else if($offer['offer_type'] == 3) { echo sprintf(__('$%.2f','offer_button'), $userOffer['offer_value']) . __(' Trade', 'offer_button');} ?></td>
